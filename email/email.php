...
$mail->AddAddress($email, 'NIlson Jr');
...
// Corpo do email
$mail->Body = 'Corpo do email em html.<br><br><font color=blue>'.$mensagem.'</font><br><br><img src="http://professornilson.com/mobile/assets/img/ifpec.png">';
