    ...
    <div class="container">
      ...
      <div class="row">
        <form class="form-horizontal" action="registraralunos.php">
          ...
          <label class="col-md-12" for="selectbasic">Listagem de aluno por disciplina</label>
    ...
    <div class="panel panel-default panel-table">
      <div class="panel-heading">
        <div class="row">
          ...
          <span class="input-group-addon fa fa-search" style="border-radius: 0px;"></span>
          <div class="col col-md-3" style="padding-left: 0px;">
            <input  ng-model="pesquisar" type="text" placeholder="Pesquise por alunos" class="form-control input-md" style="border-radius: 0px;">     
          </div>
